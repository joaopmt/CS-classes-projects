...
*/
public class JogadorRA176117b extends Jogador {
	...
	/**
	  ...
	  */
	public JogadorRA176117b(ArrayList<Carta> maoInicial, boolean primeiro){
	...
	public ArrayList<Jogada> processarTurno (Mesa mesa, Carta cartaComprada, ArrayList<Jogada> jogadasOponente){
		...
		if(minhaVida + vidaOponente > 20 || mesaLacaiosOponente.size() > mesaLacaios.size() + 1){
			modo = Modo.CONTROL;
		} else{
			modo = Modo.AGRESSION;
		}
